...
export default function SignOutPage() {
  ...
  return (
    <main
      className={`${titleFont.variable} ${uiFont.variable} relative flex min-h-screen flex-col overflow-hidden bg-[radial-gradient(circle_at_20%_10%,#93c5fd55_0%,transparent_44%),radial-gradient(circle_at_90%_90%,#67e8f966_0%,transparent_46%),linear-gradient(145deg,#f8fbff_0%,#e0f2fe_52%,#eff6ff_100%)]`}
    >
      ...
      <div className="relative flex flex-1 items-center justify-center px-6 py-16">
        <section className="relative z-10 w-full max-w-xl rounded-3xl border border-sky-100/80 bg-white/85 p-9 text-center shadow-[0_26px_60px_-32px_rgba(56,189,248,0.4)] backdrop-blur-xl">
          ...
          <button
            ...
            className="mt-8 rounded-2xl bg-linear-to-r from-sky-400 via-blue-400 to-cyan-300 px-8 py-3 text-sm font-bold uppercase tracking-[0.15em] text-white transition hover:brightness-105 [font-family:var(--font-ui)]"
          >
            Sign out now
          </button>
        </section>
