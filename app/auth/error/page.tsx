...
export default async function AuthErrorPage({ searchParams }: ErrorPageProps) {
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-[radial-gradient(circle_at_10%_12%,#93c5fd4d_0%,transparent_42%),linear-gradient(160deg,#f8fbff_0%,#e0f2fe_58%,#eff6ff_100%)] px-6 py-16">
